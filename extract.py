...
def main():
    ...
    # build datasets
    datasets = {
        "train": SALMONNFeatureDataset(data_config.prefix, data_config.train_ann_path, data_config.whisper_path),
        "valid": SALMONNFeatureDataset(data_config.prefix, data_config.valid_ann_path, data_config.whisper_path),
        "test": SALMONNFeatureDataset(data_config.prefix, data_config.test_ann_path, data_config.whisper_path),
    }
    ...
    # build runner
    runner = Extractor(cfg, model, datasets, job_id, args.dryrun)
